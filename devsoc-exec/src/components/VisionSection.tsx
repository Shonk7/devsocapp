    ...
    <Card3D>
      <Box display="flex" alignItems="center" mb={3}>
        ...
        <Typography variant="h4" component="h2">
          Visions and Actions for DevSoc
        </Typography>
      </Box>
      ...
      >
        <Box sx={{ flex: 1 }}>
          <Typography variant="body1" sx={{ mb: 2 }}>
            ...
            secure two Event Elevation Grants for our Roundhouse Events in 2023 and 2024, totally in around $10,000 of funding. 
          ...
          <Typography variant="body1" sx={{ mb: 2 }}>
            <strong>Event Responsibility Matrix:</strong> I want to create a clear responsibility matrix that shows exactly who does what and when for each event. 
